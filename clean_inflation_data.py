...
def download_file(url, dest_path):
    """
    Stream download a file from a URL to a local destination with custom headers and error handling.
    """
...
def main():
    ...
    # --- Resolve file paths ---
    file1_path = "temp/national_CPI.xlsx"
    file2_path = "temp/national_CPI_by_category.xlsx"
    file3_path = "temp/city_level_CPI.xlsx"
    
    print("Target file paths for processing:")
    ...
    for filename, df in dfs_to_export:
        ...
        # Export to CSV under the data/ directory
